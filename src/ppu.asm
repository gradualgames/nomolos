...
;this routine temporarily turns off nmi, then proceeds to fade out
;the visible palette using the palette at w0 for reference. When
;it returns, it re-enables nmi.
;expects w0 to have address of palette
.export ppu_fade_out_palette
...
:
  ...
  lda palette_step
  cmp #6
  bmi fade_out_not_done
  
  ;fade out is finished here
  jmp fade_out_done
